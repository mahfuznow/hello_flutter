...
abstract class ApiClient {
  ...
  void _logRequest(String method, Uri url,
    ...
    AppLogger.i('Sending $method request to $url');
    if (headers != null && headers.isNotEmpty) {
      var formattedHeaders = const JsonEncoder.withIndent(' ').convert(headers);
      AppLogger.t('Request Headers: $formattedHeaders');
    }
    if (data != null && data.isNotEmpty) {
      AppLogger.t('Request Data: $data');
    }
  }
  ...
  void _logResponse(http.Response response) {
    ...
    if (response.headers.isNotEmpty) {
      ...
      AppLogger.t('Response Headers: $formattedHeaders');
    }
  }
