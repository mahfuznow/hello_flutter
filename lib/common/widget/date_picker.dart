...
class _DatePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color primarySurfaceColor = isDark ? colorScheme.surface : colorScheme.surface;
    final Color onPrimarySurfaceColor = isDark ? colorScheme.onSurface : colorScheme.onSurface;
